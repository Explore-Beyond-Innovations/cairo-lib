...
fn test_rlp_decode_string() {
    ...
    loop {
        ...
        assert(res == RLPItem::Bytes((arr.span(), 1)), 'Wrong value');
...
fn test_rlp_decode_short_string() {
    ...
    let expected_item = RLPItem::Bytes((expected_res.span(), 0x9b - 0x80));
...
fn test_rlp_decode_long_string_len_1() {
    let mut arr = array![
        0xd459f97ea1f73cb8, 0x103a7b34dc8d3888, 0x6a98370c1d4385dd, 0xa4b18da3ba18bd63,
        0x6e16ecc3de246f81, 0x0479f7c4c4acb2b3, 0xda53d0c6673c76ba, 0xd97d198610ea,
    ];
    ...
    let mut expected_res = array![
        0x3888d459f97ea1f7, 0x85dd103a7b34dc8d, 0xbd636a98370c1d43, 0x6f81a4b18da3ba18,
        0xb2b36e16ecc3de24, 0x76ba0479f7c4c4ac, 0x10eada53d0c6673c, 0xd97d1986,
    ];
    let expected_item = RLPItem::Bytes((expected_res.span(), 0x3c));
    assert(res == expected_item, 'Wrong value');
}
...
fn test_rlp_decode_long_string_len_2() {
    let mut arr = array![
        0x59f97ea1f70201b9, 0x3a7b34dc8d3888d4, 0x98370c1d4385dd10, 0xb18da3ba18bd636a,
        0x16ecc3de246f81a4, 0x79f7c4c4acb2b36e, 0x53d0c6673c76ba04, 0x33d97d198610eada,
        0x6743897634694758, 0x8967953487764593, 0x3463437986433634, 0x6459836758496378,
        0x4369695874933756, 0x8963459867483967, 0x4056046337946745, 0x0365406808436839,
        0x8736956448938046, 0x9534897673568439, 0x3498609340657386, 0x5908368056048356,
        0x5940680683064568, 0x4830680384654068, 0x9568574983460365, 0x8769748376346879,
        0x4798637584635943, 0x4365879473863456, 0x5786347996346798, 0x8956873469574893,
        0x7953564973685734, 0x4738799634679543, 0x4553638967946353, 0x6868876897887968,
        0x6087997668,
    ];
    ...
    let mut expected_res = array![
        0x3888d459f97ea1f7, 0x85dd103a7b34dc8d, 0xbd636a98370c1d43, 0x6f81a4b18da3ba18,
        0xb2b36e16ecc3de24, 0x76ba0479f7c4c4ac, 0x10eada53d0c6673c, 0x69475833d97d1986,
        0x7645936743897634, 0x4336348967953487, 0x4963783463437986, 0x9337566459836758,
        0x4839674369695874, 0x9467458963459867, 0x4368394056046337, 0x9380460365406808,
        0x5684398736956448, 0x6573869534897673, 0x0483563498609340, 0x0645685908368056,
        0x6540685940680683, 0x4603654830680384, 0x3468799568574983, 0x6359438769748376,
        0x8634564798637584, 0x3467984365879473, 0x5748935786347996, 0x6857348956873469,
        0x6795437953564973, 0x9463534738799634, 0x8879684553638967, 0x9976686868876897, 0x6087,
    ];
    let expected_item = RLPItem::Bytes((expected_res.span(), 0x0102));
    assert(res == expected_item, 'Wrong value');
}
...
fn test_rlp_lazy_decode_short_list() {
    ...
    let mut expected_res = (
        RLPItem::List(
            array![
                (array![0x893535].span(), 3), (array![0x42].span(), 1),
                (array![0x923845].span(), 3),
            ]
                .span(),
        ),
        rlp_byte_len,
...
fn test_rlp_decode_long_list() {
    let mut arr = array![
        0x09cf7077a01102f9, 0xa962df351b7a06b5, 0xadecaece75818924, 0x0c4044a8b4cd681f,
        0x85a31ea0f44ac173, 0x045c6d4661b25ad0, 0x1a9fc1344568fe87, 0x35361adc184b5c4b,
        0x4c2ca0b471500260, 0x1846d1d34035ce04, 0x8366e5a5533c3072, 0x0c80a8368d4f30c1,
        0xa9a0eecd3ffaf56a, 0xc4d37d4bc58d77dc, 0xb0fe61d139e72282, 0x3717d5dcb2ceeec0,
        0xa05138a6378e5bf0, 0xdd62df56554d5fa9, 0x9b56ae97049962c2, 0x9307207bdafd8ecd,
        0xd71897db4cded3f8, 0x2238146d06d439a0, 0x74a843e9c94aaf6e, 0xb91dd8b05fc2a9a9,
        0x03e2b336138c1d86, 0x6ab4637ccc7aa04c, 0x25a141a0c9b318a4, 0x7a396b316173cb6b,
        0x13bb1b4967885ada, 0x25818a3515a03001, 0xc736fe137193c42e, 0x3497a1fb11b74680,
        0x5f78007a1829bb91, 0xd3429168a0ae52f8, 0xdfce8b1ca7faab16, 0x254e10b2db1d2049,
        0x1f2256e8c490dc0a, 0x5036dca058964a53, 0xa714a3a8fd342599, 0xb59dc7a83baeb0db,
        0xc060242ace690c55, 0xb020a0a3c1c4ad07, 0xe19e05b055663b68, 0xc1cb6b504b4ed003,
        0x11b1dab792630039, 0x8ea0e7420366c278, 0xd91c0f63fb45ebed, 0xcb17225718eb3697,
        0x03e21bb715f3d5c6, 0xa014269bd9e83cb0, 0x6f985af63da32379, 0x69b9c2e4e6f9e7d5,
        0x3999be4e94086b73, 0xf309e62f6114864a, 0x71201ad0d73465a0, 0xce46b9552afba44a,
        0xa22aadff2d22c364, 0xb12ac97334928ad1, 0xb8fe8bc2f9bfa0fd, 0xb0c3c818b6a92dbf,
        0x4714bdc0b10ce86f, 0xe229ff6121c4f738, 0x3c6961147fa02f50, 0x5ea3bb1b02a54e70,
        0x8f459e43f602c572, 0x8fea4837d02e2498, 0x805fb3e2,
    ];
    ...
    let mut expected_res = array![
        ...
        (
            array![0x6e2238146d06d439, 0xa974a843e9c94aaf, 0x86b91dd8b05fc2a9, 0x4c03e2b336138c1d]
                .span(),
            32,
        ),
        (
...
fn test_rlp_lazy_decode_long_list() {
    ...
    let expected_res = (
        RLPItem::List(
            array![
                (*expected_res_full.at(0x5), 32), (*expected_res_full.at(0x9), 32),
...
fn test_rlp_decode_list_long_string() {
    let arr = array![
        0x7235e356aca05bf8, 0x7f0b03476f57b94f, 0x4760f75aaf1d2720, 0xa9c2173ae53aab1f,
        0xf338d438b8ed276f, 0x27777eada3968dad, 0x53189e661865fe38, 0xc101f7b5d6dffd52,
        0x65454695474abcbb, 0x4567644756674547, 0x5663776535476567, 0xfa77645733,
    ];
    ...
    let expected_res = array![
        ...
        (
            array![
                0xada3968dadf338d4, 0x661865fe3827777e, 0xb5d6dffd5253189e, 0x95474abcbbc101f7,
                0x4756674547654546, 0x6535476567456764, 0xfa77645733566377,
            ]
                .span(),
            56,
        ),
